<x-user-layout title="SweetMart - Fresh Desserts Everyday">
        ...
        <div class="mockup-wrapper animate-scale">
            <div class="mockup-box">
                ...
                <div class="mockup-body">
                    <img src="{{ asset('assets/landing/chocolate-cake-premium.png') }}" class="mockup-image">
...
<section class="promo-section">
    <div class="container">
        <div class="promo-banner">
            ...
            <a href="{{ route('products.index') }}" class="promo-btn">
                Claim Promo
            </a>
        </div>
    </div>
...
<section class="featured-seller-section">
    <div class="container">
        ...
        <div class="seller-highlight">
            <img src="{{ asset('assets/landing/seller-chef.png') }}" class="seller-photo">

            <div>
                <h3 class="seller-name">Chef Amelia</h3>
                <p class="seller-desc">
                    Spesialis dessert premium dengan bahan-bahan organik dan teknik French baking.
                </p>

                <a href="#" class="btn-primary mt-4 inline-block">Visit Store</a>
            </div>
        </div>
        ...
        <div class="testimonial-grid">
            ...
            <div class="testimonial-card">
                <div class="testimonial-profile">
                    <img src="{{ asset('assets/landing/avatar'.($i+1).'.png') }}" class="testimonial-avatar">
                    <div>
                        <h4 class="testimonial-name">Customer {{ $i+1 }}</h4>
    ...
    <div class="container">
        <div class="final-cta-box">
            ...
            <p class="final-cta-subtitle">
                Dapatkan pengalaman dessert terbaik dari seller terbaik.
            </p>

            <div class="final-cta-buttons">
                <a href="{{ route('products.index') }}" class="cta-btn-white">
                    Browse Desserts
                </a>
